...
feature 'Password Reset' do
	scenario "emails user when requesting new password reset" do
		user = create(:user)	
		visit login_path 	
		click_link "password"
	...
	scenario "does not email invalid user when requesting new password reset" do
		visit login_path
		click_link "password"
	...
	scenario "reports when password reset token has expired" do
		user = create(:user, :password_reset_token => "new_token",
